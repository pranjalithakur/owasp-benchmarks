...
def init(app):
	...
	def BenchmarkTest00991_post():
		...
		paramLoc = query_string.find("BenchmarkTest00991" + '=')
		if paramLoc == -1:
			return f"request.query_string did not contain expected parameter \'{"BenchmarkTest00991"}\'."
		param = query_string[paramLoc + len("BenchmarkTest00991") + 1:]
		ampLoc = param.find('&')
		if ampLoc != -1:
			param = param[:ampLoc]
