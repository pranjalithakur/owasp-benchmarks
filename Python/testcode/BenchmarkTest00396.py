...
def init(app):
	...
	@app.route('/benchmark/weakrand-01/BenchmarkTest00396', methods=['GET'])
	def BenchmarkTest00396_get():
		return BenchmarkTest00396_post()

	@app.route('/benchmark/weakrand-01/BenchmarkTest00396', methods=['POST'])
