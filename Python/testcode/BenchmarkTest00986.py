...
def init(app):
	...
	def BenchmarkTest00986_post():
		...
		paramLoc = query_string.find("BenchmarkTest00986" + '=')
		if paramLoc == -1:
			return f"request.query_string did not contain expected parameter \'{"BenchmarkTest00986"}\'."
		param = query_string[paramLoc + len("BenchmarkTest00986") + 1:]
		ampLoc = param.find('&')
		if ampLoc != -1:
			param = param[:ampLoc]
