...
def init(app):
	...
	def BenchmarkTest00988_post():
		...
		paramLoc = query_string.find("BenchmarkTest00988" + '=')
		if paramLoc == -1:
			return f"request.query_string did not contain expected parameter \'{"BenchmarkTest00988"}\'."
		param = query_string[paramLoc + len("BenchmarkTest00988") + 1:]
		ampLoc = param.find('&')
		if ampLoc != -1:
			param = param[:ampLoc]
