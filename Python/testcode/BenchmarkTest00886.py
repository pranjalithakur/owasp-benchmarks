...
def init(app):
	...
	def BenchmarkTest00886_post():
		...
		param = wrapped.get_query_parameter("BenchmarkTest00886")
		if not param:
			param = ""
		...
		bar = 'safe!'
		conf89872 = configparser.ConfigParser()
		conf89872.add_section('section89872')
		conf89872.set('section89872', 'keyA-89872', 'a_Value')
