...
def init(app):
	...
	@app.route('/benchmark/weakrand-02/BenchmarkTest00704', methods=['GET'])
	def BenchmarkTest00704_get():
		return BenchmarkTest00704_post()

	@app.route('/benchmark/weakrand-02/BenchmarkTest00704', methods=['POST'])
