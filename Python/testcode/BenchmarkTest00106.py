...
def init(app):
	...
	@app.route('/benchmark/xpathi-00/BenchmarkTest00106', methods=['GET'])
	def BenchmarkTest00106_get():
		return BenchmarkTest00106_post()

	@app.route('/benchmark/xpathi-00/BenchmarkTest00106', methods=['POST'])
	def BenchmarkTest00106_post():
		RESPONSE = ""

		param = request.form.get("BenchmarkTest00106")
		if not param:
			param = ""
