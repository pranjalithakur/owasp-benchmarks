...
def init(app):
	...
	def BenchmarkTest00984_post():
		...
		paramLoc = query_string.find("BenchmarkTest00984" + '=')
		if paramLoc == -1:
			return f"request.query_string did not contain expected parameter \'{"BenchmarkTest00984"}\'."
		param = query_string[paramLoc + len("BenchmarkTest00984") + 1:]
		ampLoc = param.find('&')
		if ampLoc != -1:
			param = param[:ampLoc]
