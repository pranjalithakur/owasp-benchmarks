...
def init(app):
	...
	def BenchmarkTest00998_post():
		...
		paramLoc = query_string.find("BenchmarkTest00998" + '=')
		if paramLoc == -1:
			return f"request.query_string did not contain expected parameter \'{"BenchmarkTest00998"}\'."
		param = query_string[paramLoc + len("BenchmarkTest00998") + 1:]
		ampLoc = param.find('&')
		if ampLoc != -1:
			param = param[:ampLoc]
