...
def init(app):
	...
	@app.route('/benchmark/weakrand-00/BenchmarkTest00221', methods=['GET'])
	def BenchmarkTest00221_get():
		return BenchmarkTest00221_post()

	@app.route('/benchmark/weakrand-00/BenchmarkTest00221', methods=['POST'])
