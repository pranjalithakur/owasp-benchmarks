...
def init(app):
	...
	def BenchmarkTest00993_post():
		...
		paramLoc = query_string.find("BenchmarkTest00993" + '=')
		if paramLoc == -1:
			return f"request.query_string did not contain expected parameter \'{"BenchmarkTest00993"}\'."
		param = query_string[paramLoc + len("BenchmarkTest00993") + 1:]
		ampLoc = param.find('&')
		if ampLoc != -1:
			param = param[:ampLoc]
